...
},{"./beautify-html":1}],3:[function(require,module,exports){
/**
...
},{"./delta":6,"./tree":18}],4:[function(require,module,exports){
/**
...
},{"./contextdelta":3,"./delta":6,"./delta-doc":4,"./domdelta":12,"./xmlpayload":20}],6:[function(require,module,exports){
/**
...
},{"./tree":18}],7:[function(require,module,exports){
/**
...
},{"./skelmatch":17,"./tree":18}],8:[function(require,module,exports){
/**
 * @fileoverview This module contains the factory class necessary to
...
},{"./tree":18,"./xcc":19}],9:[function(require,module,exports){
/**
...
},{"./doc":11,"./domhandler":13,"./domtree":14,"./fnv132":15,"./tree":18,"./xmlpayload":20}],11:[function(require,module,exports){
/**
...
},{"./contextdelta":3,"./delta":6}],13:[function(require,module,exports){
/**
...
},{"./delta":6}],14:[function(require,module,exports){
/**
...
},{"./tree":18}],15:[function(require,module,exports){
/**
...
},{"./lcs":16}],18:[function(require,module,exports){
/**
...
},{"./lcs":16}],20:[function(require,module,exports){
/**
...
var delta = {};
//----------------------
var xccDiffProfile = require('./profiles/algo-diff-xcc');
var skelmatchDiffProfile = require('./profiles/algo-diff-skelmatch');
var docProfile = require('./profiles/doc-tree-xml');
var deltaProfile = require('./profiles/delta-tree-xml');
var diff = require('./delta/diff');
var da = require('./annot/docannotator');
//----------------------
...
var parseCorrect = function(htmlString){
	...
	console.time('br regex');
	str = str.replace(/<br>/g, "<br/>");
	console.timeEnd('br regex');
	console.time('img regex');
	str = str.replace(/(<img[^>]+)>/gm, "$1/>");
	console.timeEnd('img regex');
	console.time('nbsp regex');
	str = str.replace(/&nbsp;/g, '');
	console.timeEnd('nbsp regex');
	console.time('hr regex');
	str = str.replace(/<hr>/g, '<hr/>');
	console.timeEnd('hr regex');
...
delta.Diff = function(origcontent, changedcontent) {
    ...
    var doc1 = docProfile.loadOriginalDocument(origcontent);
    var doc2 = docProfile.loadInputDocument(changedcontent);
...
delta.annotate = function (doc, matching, invert,diff) {
	//var doc = docfact.loadOriginalDocument(docStr);
    var collector = deltaProfile.createCollector(diff, doc,
...
/*
delta.htmlDecode = function (input){
...
},{"./annot/docannotator":2,"./delta/diff":9,"./profiles/algo-diff-skelmatch":21,"./profiles/algo-diff-xcc":22,"./profiles/delta-tree-xml":23,"./profiles/doc-tree-xml":24}],26:[function(require,module,exports){
